# Snapshot report for `__tests__/crafty-preset-swc.mjs`

The actual snapshot is saved in `crafty-preset-swc.mjs.snap`.
...
> Snapshot 1

    {
      ...
      [__:__:__] Starting Crafty __version__...␊
      ␊
      __PATH__/packages/integration/fixtures/crafty-preset-swc/lints-ignore-config/crafty.config.js␊
